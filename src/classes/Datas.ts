        ...
        return `
            <div class="row p-5">
                ...
                <div class="col-md-6 text-right">
                    <p class="font-weight-bold mb-1">${this.documentType === "invoice" ? "Facture" : "Devis"}<span class="font-weight-normal">No ${Math.floor(Math.random() * 101)}</span></p>
            ...
            <div class="row pb-5 p-5">
                <div class="col-sm-6 text-left">
                    <p class="font-weight-bold">Entreprise de Kilgarrah</p>
                    <p class="mb-1">101 boulevard Arthur Merlin</p>
                    <p>75008 - Camelot</p>
